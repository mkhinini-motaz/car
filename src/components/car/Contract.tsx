...
export default function Contract({ data }: ContractProps): JSX.Element {
  ...
  return (<Section>
    ...
    <TranslatableText data={'car:contract:starts_at'} params={{ date: formatDate(data.ends_at) }} className='text-lg' />
    <TranslatableText data={'car:contract:daily_price'} params={{ price: data.daily_price }} className='text-lg' />
    <LangAwareView>
